  ...
  int cantidad; double precio;
   ...
   : nombre(nombre), cantidad(cantidad), precio(precio) {} 
	...
	void mostrarMedicamentos() {
	   ...
	   std::cout << "Nombre: " << medicamento.nombre << 
	   std::endl; std::cout << "Cantidad: " << medicamento.cantidad << 
	   std::endl; std::cout << "Precio: " << medicamento.precio <<
	...
	void venderMedicamento(std::string nombre, int cantidad) { 
	 ...
	 medicamento.cantidad -= cantidad; std::cout << "Venta exitosa" << std::endl; 
	 } else { 
